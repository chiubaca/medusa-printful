  ...
  servers: [
    {
      ...
      description:
        "The Printful API is a RESTful API, that uses the HTTP protocol for communication. HTTP GET, POST, PUT and DELETE methods are used to access the API.",
    },
  ],
  components: {
    securitySchemes: {
      ...
      Basic: {
        type: "http",
        description:
          "This is a legacy authentication method. If you are working on a new solution, please refer to our [OAuth](#section/Authentication/OAuth). For this authentification method Printful uses [HTTP basic authentication](https://en.wikipedia.org/wiki/Basic_access_authentication) and `Basic` tokens. The API key is a secret key unique to each store that is used to access the Printful API. You can enable the API and generate an API key for your store in the [store settings page](https://www.printful.com/dashboard/store). \n\n### How to start\nTo begin using Printful API with an API key, follow these steps:\n- Go to *Settings* → *Stores* → *API*\n- Select the store you would like to connect\n- Click the *Enable API Access* button\n- Receive your unique API Key\n\n```\n    # Authorized CURL request example with Basic auth\n    curl -X GET 'https://api.printful.com/store/products' \\\n    -H 'Authorization: Basic dnYwZ3RsZGctMWQ3di1xY2xxOmUydnYtbG1oZzY3NmFrMHox'\n```\n\nTo perform API-key based authentication, you need to add the `Authorization` header with a **Base64 encoded API key** when performing a request. So if the API key is `vv0gtldg-1d7v-qclq:e2vv-lmhg676ak0z1`, then you need to add this header to the API request:\n`Authorization: Basic dnYwZ3RsZGctMWQ3di1xY2xxOmUydnYtbG1oZzY3NmFrMHox`\n\n<div class=\"alert alert-info\">\nKeep the API key in secret, and never expose it in any public website's client-side code.\n</div>",
        scheme: "basic",
      },
    },
    parameters: {
    ...
    schemas: {
      ...
      OptionType: {
        ...
        properties: {
          ...
          values: {
            description: "Option values - [key, value] map",
            type: "object",
      ...
      File: {
        ...
        properties: {
          ...
          url: {
            type: "string",
            description: "Source URL where the file is downloaded from",
          },
          options: {
            type: "array",
            description: "Array of additional options for this file",
            items: {
      ...
      Item: {
        ...
        properties: {
          ...
          variant_id: {
            description: "Variant ID of the item ordered. See Products API",
            type: "integer",
            example: 1,
          },
          sync_variant_id: {
            description: "Sync variant ID of the item ordered.",
            type: "integer",
            example: 1,
          },
          external_variant_id: {
            description: "External variant ID of the item ordered.",
            type: "string",
            example: "variant-1",
          },
          warehouse_product_variant_id: {
          ...
          options: {
            type: "array",
            description: "Array of additional options for this product",
            items: {
      ...
      PackingSlip: {
        ...
        description: "Custom packing slip for this order",
        anyOf: [
          {
            required: ["email"],
          },
      ...
      GenerationTaskFilePosition: {
        ...
        properties: {
          area_width: {
            type: "integer",
            description: "Positioning area width on print area",
            example: 1800,
          },
          area_height: {
            type: "integer",
            description: "Positioning area height on print area",
            example: 2400,
          },
          width: {
            type: "integer",
            description: "Width of the image in given area",
            example: 1800,
          },
          height: {
            type: "integer",
            description: "Height of the image in given area",
            example: 1800,
          },
          top: {
            type: "integer",
            description: "Image top offset in given area",
            example: 300,
          },
          left: {
            type: "integer",
            description: "Image left offset in given area",
            example: 0,
          },
        },
      },
      ...
      WarehouseShipmentItem: {
        type: "object",
        title: "WarehouseShipmentItem",
        description: "Warehouse shipment item data",
        properties: {
          quantity: {
            type: "integer",
            description: "Quantity of item in shipment",
            example: 2,
          },
          variant: {
            $ref: "#/components/schemas/WarehouseProductVariant",
      ...
      WarehouseShipment: {
        ...
        description: "Warehouse shipment data",
        properties: {
          id: {
            type: "integer",
            description: "Shipment ID",
          ...
          location: {
            type: "string",
            description: "Warehouse which shipment is sent to",
          ...
          carrier: {
            type: "string",
            description: "Carrier delivering the shipment",
            example: "USPS",
          },
          items: {
            type: "array",
            description: "Array of items in shipment",
            items: {
              $ref: "#/components/schemas/WarehouseShipmentItem",
            },
          },
        },
      },
              ...
              allOf: [
                ...
                },
                {
                  ...
                  properties: {
                    result: {
                      type: "array",
                      description: "Array of WarehouseShipment",
                      items: {
                        $ref: "#/components/schemas/WarehouseShipment",
                      },
                    },
                  },
                },
      ...
      CreateShipment: {
        ...
        content: {
          "application/json": {
            schema: {
              type: "object",
              title: "WarehouseShipmentCreate",
              required: ["location_id", "tracking_number", "carrier", "items"],
              properties: {
                id: {
                  type: "integer",
                  description: "Shipment ID",
                ...
                items: {
                  ...
                  items: {
                    type: "object",
                    title: "WarehouseShipmentItemCreate",
                    description: "Warehouse shipment items",
  ...
  paths: {
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              'curl --location --request PUT \'https://api.printful.com/store/products/161636640\' \\\n--header \'Authorization: Basic {encoded_api_key}\' \\\n--data-raw \'{\n    "sync_product": {\n        "name": "New product name"\n    },\n    "sync_variants": [\n        {\n            "id": 1781126748,\n            "retail_price": "18.00",\n            "variant_id": 4011\n        },\n        {\n            "id": 1781126749\n        }\n    ]\n}\'',
          },
          {
            lang: "PrintfulSdk",
            source:
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              'curl --location --request PUT \'https://api.printful.com/orders/{order_id}\' \\\n--header \'Authorization: Basic {encoded_api_key}\' \\\n--data-raw \'{\n    "items": [\n        {\n            "id": 26030055,\n            "files": [\n                {\n                    "url": "https://picsum.photos/200/200?random=2"\n                }\n            ]\n        }\n    ]\n}\'',
          },
          {
            lang: "PrintfulSdk",
            source:
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              'curl --location --request POST \'https://api.printful.com/orders/estimate-costs\' \\\n--header \'Authorization: Basic {encoded_api_key}\' \\\n--data-raw \'{\n    "recipient": {\n        "name": "John Doe",\n        "address1": "19749 Dearborn St",\n        "city": "Chatsworth",\n        "state_code": "CA",\n        "country_code": "US",\n        "zip": "91311"\n    },\n    "items": [\n        {\n            "variant_id": 8630,\n            "quantity": 1,\n            "files": [\n                {\n                    "url": "https://picsum.photos/200"\n                }\n            ]\n        }\n    ]\n}\'',
          },
          {
            lang: "PrintfulSdk",
            source:
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              "curl --location --request PUT 'https://api.printful.com/sync/variant/1781126748' \\\n--header 'Authorization: Basic {encoded_api_key}' \\\n--header 'Content-Type: application/json' \\\n--data-raw '{\n    \"id\": 1781126748,\n    \"files\": [\n        {\n            \"url\": \"picsum.photos/200\"\n        }\n    ]\n}'",
          },
        ],
      },
      delete: {
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              'curl --location --request POST \'https://api.printful.com/shipping/rates\' \\\n--header \'Authorization: Basic {encoded_api_key}\' \\\n--data-raw \'{\n                "recipient": {\n                    "address1": "19749 Dearborn St",\n                    "city": "Chatsworth",\n                    "country_code": "US",\n                    "state_code": "CA",\n                    "zip": 91311\n                },\n                "items": [\n                    {\n                        "quantity": 1,\n                        "variant_id": 2\n                    },\n                    {\n                        "quantity": 5,\n                        "variant_id": 202\n                    }\n                ]\n            }\'',
          },
        ],
      },
    },
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              'curl --location --request POST \'https://api.printful.com/tax/rates\' \\\n--header \'Content-Type: application/json\' \\\n--data-raw \'{\n                "recipient": {\n                    "country_code": "US",\n                    "state_code": "CA",\n                    "city": "Chatsworth",\n                    "zip": "91311"\n                }\n            }\'',
          },
        ],
      },
    },
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              'curl --location --request POST \'https://api.printful.com/store/packing-slip\' \\\n--header \'Authorization: Basic {encoded_api_key}\' \\\n--data-raw \'{\n    "email": "email@example.com",\n    "phone": "+1 1 11111111",\n    "message": "Custom message",\n}\'',
          },
        ],
      },
    },
    ...
    "/stores/{id}": {
      get: {
        ...
        parameters: [
          {
            $ref: "#/components/parameters/StoreId-2",
          },
        ],
        responses: {
          "200": {
    ...
    "/mockup-generator/templates/{id}": {
      get: {
        ...
        responses: {
          "200": {
            $ref: "#/components/responses/Templates-2",
          },
          "401": {
            $ref: "#/components/responses/Unauthorized",
          },
    ...
    "/warehouse/products": {
      ...
      post: {
        ...
        operationId: "createWarehouseProduct",
        security: [
          {
            Basic: [],
          },
        ...
        requestBody: {
          $ref: "#/components/requestBodies/CreateWarehouseProduct",
        },
        responses: {
          "200": {
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              'curl --location --request POST \'https://api.printful.com/warehouse/products\' \\\n--header \'Content-Type: application/json\' \\\n--data-raw \'{\n                "product": {\n                    "id": 1,\n                    "name": "Example name",\n                    "status": "draft",\n                    "currency": "USD",\n                    "image_url": "url.to/image",\n                    "retail_price": 0.21,\n                    "variants": [\n                        {\n                            "id": 1,\n                            "name": "name",\n                            "sku": "example_sku",\n                            "image_url": "url.to/image",\n                            "retail_price": 0.21,\n                            "quantity": 2,\n                            "length": 5.0,\n                            "width": 5.0,\n                            "height": 5.0,\n                            "weight": 2.0\n                        }\n                    ]\n                },\n                "terms_accepted": true\n            }\'',
          },
        ],
      },
    },
    ...
    "/warehouse/shipments": {
      get: {
        summary: "Get a list of your warehouse shipments",
        description: "Returns a list of warehouse shipments from your store",
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              "curl --location --request GET 'https://api.printful.com/warehouse/shipments?status=shipped&offset=0&limit=100' \\\n--header 'Authorization: Basic {encoded_api_key}'",
          },
        ],
      },
      post: {
        summary: "Create new warehouse shipment",
        description: "Creates and submits new warehouse shipment",
        ...
        requestBody: {
          $ref: "#/components/requestBodies/CreateShipment",
        },
        responses: {
          "200": {
    ...
    "/warehouse/shipments/{id}": {
      get: {
        summary: "Get warehouse shipment data",
        description: "Returns warehouse shipment data by ID",
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              "curl --location --request GET 'https://api.printful.com/warehouse/shipments/12' \\\n--header 'Authorization: Basic {encoded_api_key}'",
          },
        ],
      },
    },
        ...
        "x-codeSamples": [
          {
            lang: "Curl",
            source:
              "curl --location --request GET 'https://api.printful.com/oauth/scopes' --header 'Authorization: Bearer {token}'",
          },
        ],
      },
    },
  ...
  "x-webhooks": {
    ...
    package_returned: {
      post: {
        ...
        description:
          " Is called when a shipment is processed as returned to the fulfillment facility. To learn more about the reasons why a shipment might be returned, take a look at [Printful's Return Policy](https://www.printful.com/policies/returns) ",
        tags: ["Webhook API"],
        requestBody: {
    ...
    product_synced: {
      post: {
        ...
        description:
          "Is called when a new product or variant is imported from store's ecommerce integration.\n\n See [Ecommerce Platform Sync API](#/tag/Ecommerce-Platform-Sync-API)",
        tags: ["Webhook API"],
        requestBody: {
    ...
    product_updated: {
      post: {
        ...
        description:
          "Is called when a new product or variant gets created or updated in any way.\n\n See [Ecommerce Platform Sync API](#/tag/Ecommerce-Platform-Sync-API)",
        tags: ["Webhook API"],
        requestBody: {
    ...
    product_deleted: {
      post: {
        ...
        description:
          "Is called when a new product or variant gets deleted.\n\n See [Ecommerce Platform Sync API](#/tag/Ecommerce-Platform-Sync-API)",
        tags: ["Webhook API"],
        requestBody: {
